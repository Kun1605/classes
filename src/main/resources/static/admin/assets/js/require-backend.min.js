...
require.config({
    ...
    include: ['css','jquery-ajax-file', 'layer', 'toastr', 'fast', 'backend', 'table', 'form', 'dragsort', 'drag', 'drop', 'addtabs', 'selectpage'],
    paths: {
        'lang': "empty:",
        'form': 'require-form',
        'table': 'require-table',
        ...
        'jquery-ajax-file': '../libs/jquery-file-upload/jquery.ajaxfileupload',
...
//        'selectpage': ['css!../libs/selectpage/selectpage.css'],
    ...
    baseUrl:'/admin/assets/js', //资源基础路径
    map: {
        '*': {
            ...
            formatter: {
            	content: function (value, row, index) {
                    ...
                    return '<a class="btn btn-xs btn-browser btn-danger ">' + value.substr(0,5) + '...</a>';
                		...
                		return '<a class="btn btn-xs btn-browser btn-danger ">' + value + '</a>'
                	}
                },
                ...
                status: function (value, row, index, custom) {
                    ...
                    var colorArr = {enabled: 'success', hidden: 'grey', disabled: 'danger', locked: 'info'};
                    //如果有自定义状态,可以按需传入
                    ...
                    //渲染状态
                    if(value==="Enabled"){
                    	var html = '<span class="text-' + color + '"><i class="fa fa-circle"></i>审核通过</span>';
                    }else{
                    	var html = '<span class="text-' + color + '"><i class="fa fa-circle"></i> 审核未通过</span>';
                    }
                    return html;
                },
