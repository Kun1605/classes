define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
	                 index_url: '/admin/articletype/datagrid',
	            	 add_url: '/admin/articletype/add',
	                 edit_url: '/admin/articletype/edit',
	                 del_url: '/admin/articletype/del',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'name', title: __('分类名称'), operate: 'LIKE %...%', placeholder: '模糊搜索', style: 'width:200px'},
