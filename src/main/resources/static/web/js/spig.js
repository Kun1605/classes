...
jQuery(document).ready(function ($) {
    $("#spig").mousedown(function (e) {
        if(e.which==3){
        showMessage("秘密通道:<br /><a href=\"http://kunakun.5166.info/\" title=\"个人主页\">个人主页</a> " +
        		"   <a href=\"http://kunakun.5166.info\" title=\"首页\">网站首页</a>",10000);
}
});
...
//鼠标在某些元素上方时
jQuery(document).ready(function ($) {
    $('.infoLeftBar').mouseover(function () {//标题被点击时
        showMessage('点击可以选择不同的菜单哦');
    });
    
  
    $(document).delegate('#article_table span[class=title] ', 'mouseover', function() {
